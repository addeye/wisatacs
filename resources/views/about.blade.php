            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="owl-single dots-absolute owl-carousel">
                        <img src="/tour/images/slider-1.jpg" alt="Free HTML Template by Untree.co" class="img-fluid rounded-20">
                        <img src="/tour/images/slider-2.jpg" alt="Free HTML Template by Untree.co" class="img-fluid rounded-20">
                        <img src="/tour/images/slider-3.jpg" alt="Free HTML Template by Untree.co" class="img-fluid rounded-20">
                        <img src="/tour/images/slider-4.jpg" alt="Free HTML Template by Untree.co" class="img-fluid rounded-20">
                        <img src="/tour/images/slider-5.jpg" alt="Free HTML Template by Untree.co" class="img-fluid rounded-20">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 mb-4">
                    <div class="team">
                        <img src="/tour/images/person_1.jpg" alt="Image" class="img-fluid mb-4 rounded-20">
                        <div class="px-3">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="team">
                        <img src="/tour/images/person_2.jpg" alt="Image" class="img-fluid mb-4 rounded-20">
                        <div class="px-3">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="team">
                        <img src="/tour/images/person_4.jpg" alt="Image" class="img-fluid mb-4 rounded-20">
                        <div class="px-3">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="team">
                        <img src="/tour/images/person_3.jpg" alt="Image" class="img-fluid mb-4 rounded-20">
                        <div class="px-3">
